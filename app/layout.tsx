...
export const metadata: Metadata = { title: "Jake Yizhou Cai — Academic Homepage", description: "Yizhou (Jake) Cai is an Assistant Professor at Texas State University working on scalable inference, dependence modeling, latent-variable models, and interdisciplinary data science.", other: { "codex-preview": "development" }, icons: { icon: "/favicon.svg", shortcut: "/favicon.svg" } };
