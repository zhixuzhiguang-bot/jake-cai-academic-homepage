...
const content = {
  en: {
    nav: ["About", "Research", "Projects", "Publications", "Teaching", "Background"],
    title: "Assistant Professor in Statistics",
    institution: "Department of Mathematics\nTexas State University",
    location: "San Marcos, Texas",
    about: "I am an Assistant Professor in Statistics at Texas State University. My research develops scalable statistical methods for high-dimensional and dependent data, with applications in public health, finance, education, and data science. I am an experienced interdisciplinary collaborator who enjoys translating methodological ideas into practical tools with academic and industry partners. I am also recruiting two Ph.D. students.",
    links: ["Email", "Curriculum Vitae", "Google Scholar", "LinkedIn"],
    researchTitle: "Research",
    researchLead: "My methodological work focuses on reliable, scalable inference for data with complex dependence, including latent-variable models and spatial or temporal pattern changes. Across these areas, I combine statistical theory, computation, and domain knowledge to build methods that remain interpretable and useful in real applications.",
    themes: [
    ...
    projects: [
      ...
      ["Statistical optimization", "Voronoi-Elitism Genetic Algorithm", "A generic derivative-free optimization routine with theory and implementation for difficult statistical objectives, currently under review at Statistics and Computing."],
      ["Ordinal tensor methods", "Cluster detection under dependence", "New methods for detecting cluster structure in dependent ordinal tensors, developed through a PI-led research project supported by Jiuxianzai Education Consulting."]
    ],
    pubTitle: "Selected publications and manuscripts",
    pubNote: "Published work appears first, followed by selected manuscripts under review. A complete list is available in my CV.",
    publications: [
    ...
    teaching: ["Texas State University|MATH 3305", "University of South Carolina|STAT 201: Elementary Statistics — Lab Instructor; STAT 704: Data Analysis I; STAT 712: Mathematical Statistics I; STAT 519: Sampling; STAT 513: Theory of Statistical Inference; STAT 512: Mathematical Statistics; STAT 511: Probability", "Jiuxianzai Education|Advanced Statistical Inference; Introduction to Machine Learning Methods; Algorithm and Data Science; Mathematical Statistics and Time Series"],
  ...
  zh: {
    ...
    researchTitle: "研究方向", researchLead: "我的方法研究聚焦复杂依赖数据的可靠、可扩展推断，包括隐变量模型以及空间和时间数据中的模式变化。在这些方向上，我结合统计理论、计算方法与领域知识，发展兼具可解释性和实际应用价值的方法。",
    ...
    projects: [["隐变量推断", "极大理想似然估计", "将隐变量视为参数的统一框架，使复杂隐变量模型更易估计、诊断并扩展至大规模数据。"], ["保险与空间风险", "大型保险理赔中的相关性", "利用空间因子 Copula 模型与可扩展复合似然方法，为冰雹损失进行考虑相关性的定价。"], ["公共卫生", "心理健康轨迹中的变点", "由精神障碍症状变化所驱动的重复多元时间序列因果与变点分析。"], ["以人为本的人工智能", "人工智能系统的偏差与实践", "研究视觉人工智能的偏差，以及全球科研人员采用生成式人工智能时的收益、担忧和实践。"], ["统计优化", "Voronoi-Elitism 遗传算法", "面向复杂统计目标函数的通用无导数优化方法，包含理论与实现，目前由 Statistics and Computing 审稿。"], ["有序张量方法", "相关结构下的聚类检测", "为具有依赖结构的有序张量开发聚类检测新方法，该项目由本人主持并获得 Jiuxianzai Education Consulting 研究经费支持。"]],
    pubTitle: "代表性论文与研究手稿", pubNote: "完整的论文、报告和在研项目列表请参见英文简历。",
    publications: [["Mohammadi, E., Thelwall, M., Cai, Y., Collier, T., & Eftekhar, A. (2025).", "生成式人工智能是否正在重塑全球学术实践？", "Information Processing & Management。", "Is Generative AI Reshaping Academic Practices Worldwide? A Survey of Adoption, Benefits, and Concerns."], ["Mohammadi, E., Cai, Y., Novin, A., Vera, V., & Mohammadi, E. S. (2025).", "谁是科学家？Google Vision AI 中的性别与种族偏差。", "AI and Ethics。", "Who is a Scientist? Gender and Racial Biases in Google Vision AI."], ["Ma, T. F., Cai, Y., Shi, P., & Zhu, J. (2024).", "大型保险理赔数据的层级相关性建模。", "The Annals of Applied Statistics, 18(2), 1402–1420。", "Hierarchical Dependence Modeling for the Analysis of Large Insurance Claims Data."], ["Lookingbill, V., Mohammadi, E., & Cai, Y. (2023).", "社交媒体短视频中饮食失调内容的准确性、用户参与度与主题评估。", "JAMA Network Open, 6(4), e238897。", "Assessment of Accuracy, User Engagement, and Themes of Eating Disorder Content in Social Media Short Videos."], ["Yin, Y., & Cai, Y.", "有序因子分析中 RMSEAD 的估计。", "Multivariate Behavioral Research，大修中。", "Estimating RMSEAD in Ordinal Factor Analysis."], ["Zou, A., Cai, Y., & Ma, T. F.", "Voronoi-Elitism 遗传算法：用于统计优化的通用无导数方法及其理论与实现。", "Statistics and Computing，在审。", "Voronoi-Elitism Genetic Algorithm: A Generic Derivative-Free Routine With Theory and Implementation for Statistical Optimization."], ["Cai, Y., Mei, S., Wu, S., Pang, W., Dong, S., & Sun, J. (2024).", "数据分析及评估方法、系统、电子存储设备。", "中国专利号 202410176158.8。", "A Data Analysis and Evaluation Method, System, Electronic Storage Equipment."]],
    teachingTitle: "教学", teaching: ["德州州立大学|MATH 3305", "南卡罗莱纳大学|STAT 201：初等统计学——实验课讲师；STAT 704：数据分析 I；STAT 712：数理统计 I；STAT 519：抽样调查；STAT 513：统计推断理论；STAT 512：数理统计；STAT 511：概率论", "Jiuxianzai Education|高级统计推断；机器学习方法导论；算法与数据科学；数理统计与时间序列"],
    ...
    appointmentItems: [["2026–至今", "助理教授", "德州州立大学"], ["2021–至今", "Human Insight for Data and AI（Hi-DA）实验室成员", "南卡罗莱纳大学"], ["2021–2026年7月", "统计教育政策研究员", "Jiuxianzai Education Consulting, LLC"], ["2025–2026", "统计咨询顾问", "南卡罗莱纳大学 Thomas Cooper 图书馆"], ["2023–2025", "实验课讲师", "南卡罗莱纳大学"], ["2019", "Fields CQAM 实验室成员", "多伦多大学"]],
...
export default function Home() {
  ...
  return <main>
    ...
    <div className="page">
      ...
      <section className="content-section" id="publications"><h2>{t.pubTitle}</h2><div className="section-body"><ol className="pub-list">{t.publications.map(([authors,title,venue,original])=><li key={title}><p>{authors}</p><p className="paper-title">{title}</p>{original&&<small className="original-title">{original}</small>}<p className="venue">{venue}</p></li>)}</ol><p className="note">{t.pubNote} <a href="/Yizhou-Jake-Cai-CV.pdf">PDF</a></p></div></section>
      <section className="content-section" id="teaching"><h2>{t.teachingTitle}</h2><div className="section-body teaching-groups">{t.teaching.map((group)=>{const [school,courses]=group.split("|");return <article key={school}><h3>{school}</h3><ul>{courses.split(/[;；]/).map(course=><li key={course}>{course.trim()}</li>)}</ul></article>})}</div></section>
