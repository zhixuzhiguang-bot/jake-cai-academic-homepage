...
const content = {
  ...
  zh: {
    ...
    appointmentItems: [["2026–至今", "助理教授", "德州州立大学"], ["2021–至今", "Human Insight for Data and AI（Hi-DA）实验室成员", "南卡罗莱纳大学"], ["2021–至今", "统计教育政策研究员", "Jiuxianzai Education Consulting, LLC"], ["2025–2026", "统计咨询顾问", "南卡罗莱纳大学 Thomas Cooper 图书馆"], ["2023–2025", "实验课讲师", "南卡罗莱纳大学"], ["2021–2023", "科研与教学助理", "南卡罗莱纳大学"], ["2019", "研究助理", "多伦多大学与 Oanda"], ["2019", "Fields CQAM 实验室成员", "多伦多大学"]],
  ...
  return <main>
    ...
    <div className="page">
      <section className="intro" id="about">
        <div className="identity"><div className="portrait-wrap"><img className="portrait" src="/profile.jpg" alt="Portrait of Yizhou (Jake) Cai" /><img className="institution-logo" src="/txst.png" alt="Texas State University logo" /></div><p className="overline">{t.institution}</p><h1>Yizhou <span>(Jake)</span> Cai</h1><p className="position">{t.title}</p><p className="location">{t.location}</p></div>
      ...
      <section className="content-section" id="teaching"><h2>{t.teachingTitle}</h2><div classN|�}��G����ƭyٜ���ѥٔ��頜蝕����͍ɥ���4(𽉽���4(�ѵ��4(