...
html = html.replace(
  "My work focuses on reliable inference under complex dependence and pattern changes in spatial and temporal data.",
  "My work focuses on reliable, scalable inference for data with complex dependence, including latent-variable models and spatial or temporal pattern changes. I combine statistical theory, computation, and domain knowledge to build interpretable methods that remain useful in real applications."
);
...
if (!html.includes('代表性论文与研究手稿')) html = html.replace(oldTeachingStart, zhProjects + zhPubs + oldTeachingStart);
html = html.replace(
